...
public class AdicionarOcorrenciaHttpDTO {
    ...
    public SituacaoDaOcorrencia getSituacaoDaOcorrencia() { return situacaoDaOcorrencia; }

    public void setSituacaoDaOcorrencia(SituacaoDaOcorrencia situacaoDaOcorrencia) { this.situacaoDaOcorrencia = situacaoDaOcorrencia; }
}
